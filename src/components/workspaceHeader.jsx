...
export default function WorkspaceHeader({ title, isFavorite }) {
    return (
        <div className="flex w-full justify-between items-center gap-3 py-3">
            ...
            <div className="bg-slate-100 p-1 rounded-md">
                <svg className={isFavorite ? "fill-amber-500 stroke-amber-500" : "stroke-charcoal"} width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
